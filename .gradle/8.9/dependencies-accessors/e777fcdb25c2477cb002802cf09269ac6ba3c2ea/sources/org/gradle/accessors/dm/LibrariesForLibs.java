...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
     ...
     * with version reference <b>google.googleid</b>
     * <p>
    ...
    public static class DatastorePreferencesLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
         ...
         * with version reference <b>data.store.preferences</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> asProvider() {
         ...
         * with version reference <b>data.store.preferences.core</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCore() {
    ...
    public static class FirebaseLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>google.firebase</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getBom() {
    ...
    public static class GithubLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>io.sceneview</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getSceneview() {
            return create("github.sceneview");
        }

    }

    public static class GoogleLibraryAccessors extends SubDependencyFactory {
        private final GoogleArLibraryAccessors laccForGoogleArLibraryAccessors = new GoogleArLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>google.ar</b>
         */
        public GoogleArLibraryAccessors getAr() {
            return laccForGoogleArLibraryAccessors;
        }

    }

    public static class GoogleArLibraryAccessors extends SubDependencyFactory {

        public GoogleArLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>core</b> with <b>com.google.ar:core</b> coordinates and
         * with version reference <b>ar.core</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCore() {
            return create("google.ar.core");
        }
    ...
    public static class PlayServicesLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>play.services.cronet</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class Retrofit2ConverterLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>retrofit.converterGson</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final ArVersionAccessors vaccForArVersionAccessors = new ArVersionAccessors(providers, config);
        ...
        /**
         * Version alias <b>espressoCore</b> with value <b>3.5.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>uiTestJunit4Android</b> with value <b>1.7.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Group of versions at <b>versions.ar</b>
         */
        public ArVersionAccessors getAr() {
            return vaccForArVersionAccessors;
        }
    ...
    public static class ActivityVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Version alias <b>activity.ktx</b> with value <b>1.9.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class ArVersionAccessors extends VersionFactory  {

        public ArVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>ar.core</b> with value <b>1.33.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getCore() { return getVersion("ar.core"); }
    ...
    public static class DataVersionAccessors extends VersionFactory  {
        ...
        /**
         * Group of versions at <b>versions.data.store</b>
         */
        public DataStoreVersionAccessors getStore() {
    ...
    public static class DataStoreVersionAccessors extends VersionFactory  {
        ...
        private final DataStorePreferencesVersionAccessors vaccForDataStorePreferencesVersionAccessors = new DataStorePreferencesVersionAccessors(providers, config);
        public DataStoreVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of versions at <b>versions.data.store.preferences</b>
         */
        public DataStorePreferencesVersionAccessors getPreferences() {
            return vaccForDataStorePreferencesVersionAccessors;
        }

    }

    public static class DataStorePreferencesVersionAccessors extends VersionFactory  implements VersionNotationSupplier {

        public DataStorePreferencesVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>data.store.preferences</b> with value <b>1.1.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> asProvider() { return getVersion("data.store.preferences"); }

        /**
         * Version alias <b>data.store.preferences.core</b> with value <b>1.1.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getCore() { return getVersion("data.store.preferences.core"); }
    ...
    public static class GoogleVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>google.firebase</b> with value <b>33.7.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getFirebase() { return getVersion("google.firebase"); }

        /**
         * Version alias <b>google.googleid</b> with value <b>1.1.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGoogleid() { return getVersion("google.googleid"); }
    ...
    public static class IoVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>io.sceneview</b> with value <b>2.2.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSceneview() { return getVersion("io.sceneview"); }
    ...
    public static class PlayServicesVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>play.services.cronet</b> with value <b>18.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getCronet() { return getVersion("play.services.cronet"); }
    ...
    public static class RetrofitVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Version alias <b>retrofit.converterGson</b> with value <b>2.11.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getConverterGson() { return getVersion("retrofit.converterGson"); }
